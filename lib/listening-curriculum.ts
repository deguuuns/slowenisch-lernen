...
import { listeningStageKey } from '@/lib/skill-mastery'
...
export const LISTENING_CURRICULUM:ListeningItem[]=[
 {id:'listen-word-place',stage:'word',title:'Orte erkennen',text:'doma, Slovenija, trgovina, restavracija',translation:'zu Hause, Slowenien, Geschäft, Restaurant',requiredWords:['doma','Slovenija','trgovina','restavracija'],recommendedSpeed:'verySlow',targetKeys:['skill:listening',listeningStageKey('word'),'vocab:places'],prompts:[{question:'Welches Wort bedeutet „zu Hause“?',options:['doma','trgovina','Slovenija'],answer:'doma'}]},
 {id:'listen-sentence-location',stage:'sentence',title:'Ort verstehen',text:'Danes sem v Sloveniji.',translation:'Heute bin ich in Slowenien.',requiredWords:['danes','Slovenija'],recommendedSpeed:'slow',targetKeys:['skill:listening',listeningStageKey('sentence'),'grammar:case:locative'],prompts:[{question:'Kje sem danes?',options:['V Sloveniji','V Nemčiji','Doma'],answer:'V Sloveniji'}]},
 {id:'listen-sentence-direction',stage:'sentence',title:'Richtung verstehen',text:'Jutri grem v trgovino.',translation:'Morgen gehe ich in das Geschäft.',requiredWords:['jutri','iti','trgovina'],recommendedSpeed:'slow',targetKeys:['skill:listening',listeningStageKey('sentence'),'grammar:case:accusative'],prompts:[{question:'Kam grem jutri?',options:['V trgovino','V službi','Doma'],answer:'V trgovino'}]},
 {id:'listen-dialogue-restaurant',stage:'dialogue',title:'Im Restaurant',text:'Dober dan. Kaj želite piti? Želim vodo, prosim. Seveda. Želite še kaj? Ne, hvala.',translation:'Guten Tag. Was möchten Sie trinken? Ich möchte Wasser, bitte. Natürlich. Möchten Sie noch etwas? Nein, danke.',requiredWords:['dober dan','želeti','piti','voda','prosim','hvala'],recommendedSpeed:'normal',targetKeys:['skill:listening',listeningStageKey('dialogue'),'grammar:topic:restaurant'],prompts:[{question:'Kaj želi gost piti?',options:['Vodo','Kavo','Čaj'],answer:'Vodo'},{question:'Ali želi še kaj?',options:['Ne','Da','Ne vemo'],answer:'Ne'}]},
 {id:'listen-dialogue-travel',stage:'dialogue',title:'Unterwegs',text:'Kam greš danes? Grem v Ljubljano. Kako greš? Peljem se z avtom.',translation:'Wohin gehst/fährst du heute? Ich fahre nach Ljubljana. Wie fährst du? Ich fahre mit dem Auto.',requiredWords:['kam','danes','iti','Ljubljana','peljati se','avto'],recommendedSpeed:'normal',targetKeys:['skill:listening',listeningStageKey('dialogue'),'grammar:topic:travel','grammar:case:accusative'],prompts:[{question:'Kam gre oseba?',options:['V Ljubljano','Domov','V Maribor'],answer:'V Ljubljano'},{question:'Kako gre?',options:['Z avtom','Z vlakom','Peš'],answer:'Z avtom'}]},
 {id:'listen-story-day',stage:'story',title:'Moj dan',text:'Zjutraj pijem kavo in potem grem v službo. Popoldne grem v trgovino. Zvečer sem doma in kuham večerjo.',translation:'Morgens trinke ich Kaffee und gehe danach zur Arbeit. Nachmittags gehe ich einkaufen. Abends bin ich zu Hause und koche Abendessen.',requiredWords:['zjutraj','piti','kava','služba','popoldne','trgovina','zvečer','doma','kuhati'],recommendedSpeed:'normal',targetKeys:['skill:listening',listeningStageKey('story'),'grammar:topic:daily-routine'],prompts:[{question:'Kam grem zjutraj?',options:['V službo','Domov','V hotel'],answer:'V službo'},{question:'Kje sem zvečer?',options:['Doma','V trgovini','V službi'],answer:'Doma'}]},
]
