...
export const foundationExercises: Exercise[] = [
  {
    ...
    level: 'A1', difficulty: 1, skills: ['wortschatz','schreiben'], introducesVocabulary: ['dober dan'], learningTargets: ['chunk:dober-dan'], contentKey: 'chunk-dober-dan', contextTag: 'begrüßung',
  },
  {
    ...
    level: 'A1', difficulty: 1, skills: ['wortschatz','schreiben'], introducesVocabulary: ['dobro jutro'], learningTargets: ['chunk:dobro-jutro'], contentKey: 'chunk-dobro-jutro', contextTag: 'begrüßung',
  },
  {
    ...
    level: 'A1', difficulty: 1, skills: ['wortschatz','schreiben'], introducesVocabulary: ['dober večer'], learningTargets: ['chunk:dober-vecer'], contentKey: 'chunk-dober-vecer', contextTag: 'begrüßung',
  },
  {
    ...
    requiredVocabulary: ['sem'], introducesVocabulary: ['si'], introducesGrammar: ['biti-basic'], learningTargets: ['conjugation:biti:ti','grammar:biti-basic'], contentKey: 'biti-si-intro', contextTag: 'biti',
  },
  {
    ...
    requiredVocabulary: ['si'], requiredGrammar: ['biti-basic'], introducesVocabulary: ['je'], learningTargets: ['conjugation:biti:on-ona','grammar:biti-basic'], contentKey: 'biti-je-intro', contextTag: 'biti',
  },
  {
    ...
    skills: ['grammatik','lesen'], requiredVocabulary: ['sem','si','je'], requiredGrammar: ['biti-basic'], learningTargets: ['conjugation:biti:ti','grammar:biti-basic'], contentKey: 'biti-ti-choice', contextTag: 'biti',
  },
  {
    ...
    skills: ['wortschatz','schreiben'], introducesVocabulary: ['kje'], learningTargets: ['vocab:kje'], contentKey: 'kje-intro', contextTag: 'ort-richtung',
  },
  {
    ...
    skills: ['wortschatz','schreiben'], requiredVocabulary: ['kje'], introducesVocabulary: ['kam'], learningTargets: ['vocab:kam'], contentKey: 'kam-intro', contextTag: 'ort-richtung',
  },
  {
    ...
    skills: ['wortschatz','grammatik','schreiben'], introducesVocabulary: ['grem'], introducesGrammar: ['iti-1s'], learningTargets: ['vocab:grem','conjugation:iti:jaz'], contentKey: 'grem-intro', contextTag: 'bewegung',
  },
  {
    ...
    skills: ['grammatik','lesen','schreiben'], requiredVocabulary: ['kje','kam','grem','sem'], introducesGrammar: ['kje-kam','location-direction'], learningTargets: ['grammar:kje-kam','grammar:location-direction'], contentKey: 'kje-kam-intro', contextTag: 'ort-richtung',
  },
]
