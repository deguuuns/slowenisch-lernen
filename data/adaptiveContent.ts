...
const transferExercises: Exercise[] = [
  {
    ...
    grammarTag: 'dual', requiredGrammar: ['dual'], learningTargets: ['grammar:dual'],
  ...
  },
  {
    ...
    grammarTag: 'location-direction', requiredVocabulary: ['sem'], requiredGrammar: ['location-direction'], learningTargets: ['grammar:location-direction']
  },
  {
    ...
    grammarTag: 'location-direction', requiredVocabulary: ['grem'], requiredGrammar: ['location-direction'], learningTargets: ['grammar:location-direction']
  },
  {
    id: 't-home-1', lesson: 3, type: 'fill', level: 'A1', difficulty: 2,
    prompt: 'Zdaj sem ___. (zu Hause)', answer: 'doma', skills: ['grammatik','wortschatz'],
    grammarTag: 'location-direction', requiredVocabulary: ['sem','doma'], requiredGrammar: ['location-direction'], learningTargets: ['grammar:doma-domov']
  },
  {
    ...
    grammarTag: 'location-direction', requiredVocabulary: ['grem'], requiredGrammar: ['location-direction'], learningTargets: ['grammar:doma-domov']
  },
  {
    ...
    grammarTag: 'time-number-form', requiredGrammar: ['time-number-form'], learningTargets: ['grammar:time-number-form']
  },
  {
    id: 't-pizza-1', lesson: 4, type: 'fill', level: 'A1', difficulty: 2,
    prompt: 'Jem ___. (Pizza)', answer: 'pico', skills: ['grammatik','schreiben'],
    grammarTag: 'accusative', requiredGrammar: ['accusative'], learningTargets: ['grammar:accusative']
  },
]
