...
export const lesson6Exercises: Exercise[] = [
  { id:'e33', lesson:6, type:'translate-de-sl', prompt:'Ich suche ein T-Shirt.', answer:'Iščem majico.', vocabularyIds:['v123'], grammarRuleIds:['shopping-request-basics'], evaluationMode:'acceptedVariants', acceptedAnswers:[], skillTargets:['production'], difficulty:'easy', responseScope:'fixed' },
  { id:'e34', lesson:6, type:'translate-de-sl', prompt:'Ich möchte ein rotes T-Shirt.', answer:'Želim rdečo majico.', vocabularyIds:['v131'], grammarRuleIds:['shopping-request-basics','accusative-feminine-a-o'], evaluationMode:'grammar', acceptedAnswers:[], skillTargets:['production','grammar-application'], difficulty:'normal', responseScope:'fixed' },
  { id:'e35', lesson:6, type:'translate-de-sl', prompt:'Ich brauche eine große Tasche.', answer:'Potrebujem veliko torbo.', vocabularyIds:['v124','v129'], grammarRuleIds:['shopping-request-basics'], evaluationMode:'acceptedVariants', acceptedAnswers:[], skillTargets:['production'], difficulty:'normal', responseScope:'fixed' },
  ...
  { id:'e38', lesson:6, type:'translate-de-sl', prompt:'Haben Sie eine kleinere Größe?', answer:'Imate manjšo številko?', vocabularyIds:['v130','v136'], grammarRuleIds:['shopping-request-basics'], evaluationMode:'acceptedVariants', acceptedAnswers:[], skillTargets:['production'], difficulty:'normal', responseScope:'fixed' },
  { id:'e39', lesson:6, type:'translate-de-sl', prompt:'Ich bezahle mit Karte.', answer:'Plačam s kartico.', vocabularyIds:['v138','v140'], grammarRuleIds:['shopping-payment'], evaluationMode:'acceptedVariants', acceptedAnswers:[], skillTargets:['production'], difficulty:'normal', responseScope:'fixed' },
  ...
  { id:'e41', lesson:6, type:'translate-de-sl', prompt:'Wo kann ich bezahlen?', answer:'Kje lahko plačam?', vocabularyIds:['v140','v026'], grammarRuleIds:['shopping-payment'], evaluationMode:'acceptedVariants', acceptedAnswers:[], skillTargets:['production'], difficulty:'normal', responseScope:'fixed' },
  { id:'e42', lesson:6, type:'choice', prompt:'Welche Antwort passt zu „Ich möchte Brot kaufen.“?', answer:'Želim kupiti kruh.', alternatives:['Potrebujem rdečo majico.','Plačam s kartico.','To je poceni.'], vocabularyIds:['v122','v092'], grammarRuleIds:['shopping-request-basics'], evaluationMode:'exact', acceptedAnswers:[], skillTargets:['recognition'], difficulty:'easy', responseScope:'fixed' },
  { id:'e43', lesson:6, type:'free', prompt:'Antworte im Geschäft: Kaj iščete? (Was suchen Sie?)', answer:'Iščem majico.', acceptedAnswers:['Iščem kruh.','Iščem denarnico.'], vocabularyIds:['v123'], grammarRuleIds:['shopping-request-basics'], evaluationMode:'open', skillTargets:['production'], difficulty:'normal', responseScope:'personal-open' },
