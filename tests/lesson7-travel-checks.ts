...
assert.ok(v2Words.every(item=>item.cefrLevel==='A1'&&item.curriculumUnit==='A1.7 Unterwegs'), 'Neue V2-Wörter in Lektion 7 müssen definierte A1.7-Erweiterungen sein')
