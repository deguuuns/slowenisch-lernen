...
const now=Date.now()
const base={...defaultProgress,preferences:{...defaultProgress.preferences,dailyGoalMinutes:10},reviews:[{key:'vocab:v001',dueAt:now-1000,lastReviewedAt:now-86_400_000,intervalDays:1,ease:2.3}],mastery:{...defaultProgress.mastery,'skill:listening':{score:.42,attempts:5,correct:2,incorrect:3,lastAttemptAt:now-1000}}}
...
const fresh={...defaultProgress,preferences:{...defaultProgress.preferences,dailyGoalMinutes:15},reviews:[],mastery:{}}
