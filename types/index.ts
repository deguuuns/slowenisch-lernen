...
export type ExamHistoryItem = { sessionId:string; kind:'checkpoint'|'final'; lessonId:number; exerciseIds:string[]; firstExerciseIds:string[]; promptSignatures:string[]; vocabularyIds:string[]; grammarRuleIds:string[]; completedAt:number }
