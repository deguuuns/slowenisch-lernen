...
const cases:Record<string,Exercise[]>={
  ...
  'wordbank':[{id:'qa-wordbank',lesson:2,type:'free',prompt:'Baue den Satz: Ich habe zwei Brüder.',answer:'Imam dva brata.',wordBank:['Imam','dva','brata.'],skillTargets:['production','grammar-application'],grammarRuleIds:['dual'],learningPhase:'guided-production'}],
  'conjugation':[{id:'qa-conjugation',lesson:2,type:'free',prompt:'Setze govoriti für „wir beide“ ein: Midva ___ slovensko.',answer:'govoriva',acceptedAnswers:['govoriva'],skillTargets:['production','grammar-application'],grammarRuleIds:['dual','conjugation'],learningPhase:'variation'}],
  'dual':[{id:'qa-dual',lesson:2,type:'free',prompt:'Übersetze: Ich habe zwei Brüder.',answer:'Imam dva brata.',skillTargets:['production','grammar-application'],grammarRuleIds:['dual'],learningPhase:'variation',explanation:'Bei zwei männlichen Personen verwendet Slowenisch den Dual. Deshalb steht nach dva die Dualform brata.'}],
  'long-feedback':[{id:'qa-long-feedback',lesson:2,type:'free',prompt:'Übersetze: Ich habe zwei Brüder.',answer:'Imam dva brata.',skillTargets:['production','grammar-application'],grammarRuleIds:['dual'],learningPhase:'variation',explanation:'Die Zahl dva wird mit männlichen Substantiven verwendet. Bei genau zwei Personen steht brat im Dual als brata; dve gehört hier nicht zu brat.'}],
  'error-review':[
    {id:'qa-error-a',lesson:2,type:'free',prompt:'Übersetze: Ich habe zwei Brüder.',answer:'Imam dva brata.',skillTargets:['production','grammar-application'],grammarRuleIds:['dual'],learningPhase:'variation'},
    {id:'qa-error-b',lesson:2,type:'choice',prompt:'Welche Form gehört zu zwei Schwestern?',answer:'dve sestri',alternatives:['dva sestri','dve sestre','dva sestre'],skillTargets:['recognition','grammar-application'],grammarRuleIds:['dual'],learningPhase:'recognize'},
  ],
}
